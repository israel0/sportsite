        ...
        <div class="">
            ...
            <div id="navbar-collapse" class="navbar-menu collapse navbar-collapse hidden-xs">
                <ul class="nav navbar-nav navbar-left hidden-xs">
                    ...
                    <li class="dropdown">
                        <button class="btn btn-primary dropdown-toggle"  data-toggle="dropdown">CHANGE plan</button>
                        <ul class="dropdown-menu">
                            @foreach($plans as $plan)
                                <li><a href="<?php echo route('admin_stages', ['plan' => $plan->id, 'stage_id' => $stage_id]) ?>"> {{ $plan->name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right hidden-xs">
                    ...
                    <li><a href="<?php echo url("user"); ?>"><span class="fa fa-user"></span> Dashboard</sup></a></li>                    
