                ...
                <div class="login-form-div">
                    ...
                    <nav>
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="<?php echo url("admin/view_user/$user->userName") ?>">Personal Information</a></li>
                            ...
                            <div class="user-main-container col-ms-12">
                                <div class="list-group">
                                    ...
                                    <div class="list-group-item">
                                        ...
                                        <form action="<?php echo url("admin/update_user/$user->userName") ?>" method="post">
                                            @csrf
                                            @if(session('error'))
