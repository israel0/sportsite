                ...
                <div class="login-form-div">
                    ...
                    <nav>
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="<?php echo url("admin/change_password/$user->userName") ?>">Change Password</a></li>
                            <li><a href="<?php echo url("admin/change_pin/$user->userName") ?>">Transaction Pin</a></li>
                        </ul>
                    </nav>
                            ...
                            <div class="user-main-container col-ms-12">
                                <div class="list-group">
                                    ...
                                    <div class="list-group-item">
                                        <form action="<?php echo url("admin/update_password/$user->userName") ?>" method="post">
                                            @csrf
                                            @if(session('error'))
