            ...
            <div class="login-form-div">
                ...
                <nav>
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a  href="{{ route("send_code")}}">Send Codes</a></li>
                    </ul>
                  </nav>
                  <form action="{{  route("send-activation-code") }}" method="post">
                    @csrf
                      ...
                      <br>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <label for="reviewField" class="control-label">UserName</label>
                                                </div>
                                                <div class="col-sm-6">
...
<br>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select value="{{old('plan')}}" name="plan" class="form-control"
                                            data-style="btn btn-primary" title="Choose Packge" id="plan">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="flex">
                                                <input type="submit" value="SEND ACTIVATION CODE" class="btn btn-primary btn-block">
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
