...
<li><a  href="{{ route("user_change_pin")}}">Change pin</a></li>
<li class="active"><a  href="{{ route("user_change_pin")}}">Transaction Pin</a></li>
</ul>
</nav>
...
<div class="list-group-item">
    <form action="{{ route('pin_update_account')}}" method="post">
        @csrf
        @if(session('error'))
